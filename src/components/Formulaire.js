    ...
    return (
        <form id="main">
            <div id="first" className="first">
                <fieldset className="partie">
                    <h2> Informations personelles</h2>
                    <label>
                        {" "}
                        Nom et prenom :{" "}
                    </label> <input type="text"></input> <br />
                    <label> Date de naissance : </label>{" "}
                    <input type="date"></input>
                </fieldset>
                <fieldset>
                    <h2> Informations du compte</h2>
                    <label> Pseudo : </label> <input type="text"></input> <br />
                    <label> Mail : </label> <input type="mail"></input> <br />
            ...
            <div id="second" className="second">
                <fieldset className="partie">
                    ...
                    <label> Rue : </label> <input type="text"></input>
                    <br />
                    <label>
                        {" "}
                        Code postal :{" "}
                    </label> <input type="text"></input> <br />
                    <label> Ville : </label> <input type="text"></input>
                    <br />
                    <label> pays : </label>{" "}
                    <select name="pays">
                        ...
                        <option value="Tunisie" selected="true">
                            Tunisie{" "}
                        </option>
                ...
                <fieldset>
                    ...
                    <label>
                        {" "}
                        date d'expiration :{" "}
                    </label> <input type="month" /> <br />
                    <label> ccv : </label> <input type="password"></input>{" "}
                    <br />
                </fieldset>
            </div>
        </form>
